...
import static com.frontwit.barcodeapp.administration.processing.front.model.Stage.*
import static java.time.LocalDateTime.now

class FrontProcessingScenarios extends Specification implements SampleFront {
