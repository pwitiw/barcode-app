...
import com.frontwit.barcodeapp.domain.order.processing.dto.IllegalProcessingOrderException;
import com.frontwit.barcodeapp.domain.order.processing.dto.ProcessCommand;
import com.frontwit.barcodeapp.domain.order.processing.dto.ProcessNotAllowedException;
...
//TODO jak w przypadku poprawek, ile mozna maksymalnie?
@Builder
class Component {
